...
const ALFRESCO_PUBLIC_V1_PEOPLE_BASE_PATH = '/alfresco/api/-default-/public/alfresco/versions/1/people';
const ALFRESCO_PUBLIC_V1_GROUPS_BASE_PATH = '/alfresco/api/-default-/public/alfresco/versions/1/groups';
...
export const ALFRESCO_NODE_VERSIONS_PATH_TEMPLATE = `${ALFRESCO_PUBLIC_V1_NODES_BASE_PATH}/{nodeId}/versions`;
...
export const ALFRESCO_PERSON_PATH_TEMPLATE = `${ALFRESCO_PUBLIC_V1_PEOPLE_BASE_PATH}/{personId}`;
export const ALFRESCO_GROUP_PATH_TEMPLATE = `${ALFRESCO_PUBLIC_V1_GROUPS_BASE_PATH}/{groupId}`;
export const ALFRESCO_GROUP_MEMBERS_PATH_TEMPLATE = `${ALFRESCO_PUBLIC_V1_GROUPS_BASE_PATH}/{groupId}/members`;
export const ALFRESCO_GROUP_MEMBER_PATH_TEMPLATE =
  `${ALFRESCO_PUBLIC_V1_GROUPS_BASE_PATH}/{groupId}/members/{memberId}`;
...
export function getAlfrescoGroupMemberPath(groupId: string, memberId: string): string {
  return ALFRESCO_GROUP_MEMBER_PATH_TEMPLATE.replace('{groupId}', groupId).replace('{memberId}', memberId);
}
