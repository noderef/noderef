...
export const ALFRESCO_NODE_CHILDREN_PATH_TEMPLATE = `${ALFRESCO_PUBLIC_V1_NODES_BASE_PATH}/{parentId}/children`;
export const ALFRESCO_NODE_CONTENT_PATH_TEMPLATE = `${ALFRESCO_PUBLIC_V1_NODES_BASE_PATH}/{nodeId}/content`;
...
export const ALFRESCO_GROUP_MEMBER_PATH_TEMPLATE = `${ALFRESCO_PUBLIC_V1_GROUPS_BASE_PATH}/{groupId}/members/{memberId}`;
